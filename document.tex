...
\begin{document}
	...
	\begin{itemize}[label=\textbullet, itemsep=0.05cm]
		...
		\item \textit{Implemented} color detection and object tracking with live calibration functionality
	...
	\begin{itemize}[label=\textbullet, itemsep=0.05cm]
		...
		\item Integrate with AWS Cognito for authentication and AWS DynamoDB for scalable data storage
	\end{itemize}
	...
	\begin{itemize}[label=\textbullet, itemsep=0.05cm]
		\item Currently using a comprehensive Nix-based desktop, Including hyprland, waybar, alacritty, and neovim
	\end{itemize}
